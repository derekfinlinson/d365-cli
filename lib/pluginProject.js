...
function write(answers) {
    ...
    fs.copyFileSync(path.resolve(templatePath, 'IBasePlugin.cs'), path.resolve(destinationPath, 'Plugin', 'IBasePlugin.cs'));
    ...
    fs.copyFileSync(path.resolve(templatePath, 'BasePluginContext.cs'), path.resolve(destinationPath, 'Plugin', 'BasePluginContext.cs'));
