...
function write(answers) {
    ...
    // Write base plugin files
    fs.copyFileSync(path.resolve(templatePath, 'BasePlugin.cs'), path.resolve(destinationPath, 'Plugin', 'BasePlugin.cs'));
    fs.copyFileSync(path.resolve(templatePath, 'BasePluginHandler.cs'), path.resolve(destinationPath, 'Plugin', 'BasePluginHandler.cs'));
    fs.copyFileSync(path.resolve(templatePath, 'Extensions.cs'), path.resolve(destinationPath, 'Plugin', 'Extensions.cs'));
    fs.copyFileSync(path.resolve(templatePath, 'IExtendedPluginContext.cs'), path.resolve(destinationPath, 'Plugin', 'IExtendedPluginContext.cs'));
    fs.copyFileSync(path.resolve(templatePath, 'IPluginHandler.cs'), path.resolve(destinationPath, 'Plugin', 'IPluginHandler.cs'));
    fs.copyFileSync(path.resolve(templatePath, 'LocalPluginContext.cs'), path.resolve(destinationPath, 'Plugin', 'LocalPluginContext.cs'));
    fs.copyFileSync(path.resolve(templatePath, 'PipelineStage.cs'), path.resolve(destinationPath, 'Plugin', 'PipelineStage.cs'));
    fs.copyFileSync(path.resolve(templatePath, 'RegisteredEvent.cs'), path.resolve(destinationPath, 'Plugin', 'RegisteredEvent.cs'));
